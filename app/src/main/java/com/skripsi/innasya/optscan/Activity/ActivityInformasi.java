...
public class ActivityInformasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resource = new resource(ActivityInformasi.this);
        ...
        pestButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ActivityInformasi.this,ActivityPestisidaHama.class);
                intent.putExtra("opt_id", mViewPager.getCurrentItem());
                ActivityInformasi.this.startActivity(intent);
            }
        });
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            namaOPT.setText(resource.getDataRowOPT()[(getArguments().getInt(ARG_SECTION_NUMBER))-1][1]);
            latin.setText(resource.getDataRowOPT()[(getArguments().getInt(ARG_SECTION_NUMBER))-1][2]);
            desc.setText(resource.getDataRowOPT()[(getArguments().getInt(ARG_SECTION_NUMBER))-1][3]);

            fotoInfo.setScaleType(ImageView.ScaleType.CENTER_CROP);
            fotoInfo.setImageResource(resource.getGambarDataRowOPT()[(getArguments().getInt(ARG_SECTION_NUMBER))-1]);
