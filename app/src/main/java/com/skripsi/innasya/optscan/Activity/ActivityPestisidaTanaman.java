...
public class ActivityPestisidaTanaman extends AppCompatActivity {
    SQLHelper sqlHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] judul = {"Bercak Ungu","Busuk Daun","Embun Bulu","Layu Fusarium","Busuk Leher Akar"};
        ...
        for (Pestisida p : sqlHelper.getAllPestisidaById(id)) {
            pestisidaList.add(p);
        }
